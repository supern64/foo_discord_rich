...
PreferenceTabMain::PreferenceTabMain( PreferenceTabManager* pParent )
    ...
    , timeSettings_( config::timeSettings, { { TimeSetting::Elapsed, IDC_RADIO_TIME_ELAPSED }, { TimeSetting::Disabled, IDC_RADIO_TIME_DISABLED } } )
    , statusSettings_( config::statusSettings, { { StatusSetting::Name, IDC_RADIO_STATUS_NAME }, { StatusSetting::Top, IDC_RADIO_STATUS_TOP }, { StatusSetting::Middle, IDC_RADIO_STATUS_MIDDLE } } )
